  ...
  switch (current_state) {
    ...
    case ALIGN:
      if (currentTime - startTime < 1000) {
        Serial.println(phi);
        Serial.println(marker_phi_rel);
        Serial.println(marker_phi_abs);
        Serial.println();
        Serial.flush();
        break;
      }
      ...
      if (align && found_marker) {
        marker_phi_at_align_start = marker_phi_abs;
      ...
      } else if (found_marker && abs(marker_phi_at_align_start - phi) <= 0.03) {
